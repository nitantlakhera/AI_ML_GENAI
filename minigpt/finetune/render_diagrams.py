"""
render_diagrams.py  (finetune/)
--------------------------------
Render every ```mermaid block in FLOW.md, ARCHITECTURE.md, and USER_GUIDE.md
to PNG files in diagrams/ via the mermaid.ink service.
...
DOC_FILES = ["COMPLETE_MANUAL.md", "FLOW.md", "ARCHITECTURE.md", "USER_GUIDE.md"]
